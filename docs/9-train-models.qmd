...
### The different types of segmentation {#the-different-types-of-segmentation}
...
### Evaluating alternatives: Is DL the right choice? {#evaluating-alternatives:-is-dl-the-right-choice?}
...
## Implementing a DL segmentation workflow {#implementing-a-dl-segmentation-workflow}

### Overview of a typical DL segmentation workflow {#overview-of-a-typical-dl-segmentation-workflow}
...
### Deciding whether to train a new model {#deciding-whether-to-train-a-new-model}

![**Figure 4: Decision workflow for selecting a deep learning model training approach.** This flowchart outlines how to determine an appropriate training approach based on the availability and performance of pre-trained models. ](9-figures/chapter9_4_training approach.png)
...
#### When to train your model {#when-to-train-your-model}
...
### Preparing your dataset for training {#preparing-your-dataset-for-training}
...
#### Types of model training {#types-of-model-training}
...
#### Creating Manual Annotations {#creating-manual-annotations}
...
#### Accelerating annotation with pre-trained models {#accelerating-annotation-with-pre-trained-models}
...
#### Expanding your dataset with augmentation and synthetic data {#expanding-your-dataset-with-augmentation-and-synthetic-data}
...
#### Choosing the dataset size: specific vs. general models {#choosing-the-dataset-size:-specific-vs.-general-models}
...
### Training a segmentation model from scratch {#training-a-segmentation-model-from-scratch}
...
#### Splitting your training data: training, validation, and test sets {#splitting-your-training-data:-training,-validation,-and-test-sets}
...
#### Choosing your model hyperparameters {#choosing-your-model-hyperparameters}
...
#### Monitoring training and validation Losses {#monitoring-training-and-validation-losses}
...
![**Figure 6: Monitoring training and validation losses during model training.** ](9-figures/chapter9_6_Underfitting_VS_Overfitting.png)
...
###  Fine-Tuning Pre-existing Models {#fine-tuning-pre-existing-models}
...
#### Conducting fine-tuning {#conducting-fine-tuning}
...
#### Iterative training: keeping humans in the loop {#iterative-training:-keeping-humans-in-the-loop}
...
### Deploying your model on new data {#deploying-your-model-on-new-data}
...
![**Figure 10: Common deep learning segmentation problems and troubleshooting tips.**](9-figures/chapter9_10_Does yout model work.png)
...
## Further considerations for DL segmentation {#further-considerations-for-dl-segmentation}

### Choosing the Right Tools for DL {#choosing-the-right-tools-for-dl}
...
### Managing Computational Resources {#managing-computational-resources}
