...
1. **Open Fiji – activate the LOCI update site and restart Fiji.**  
   LOCI tools are required for exporting ROI maps. To enable them, go to *Help > Upate > Manage Update Sites*, look for 'LOCI' and check the *Active* checkbox. Then, clik on *Apply and Close* and *Apply Changes*, this update site ensures the necessary plugins are installed. Finally, restart Fiji.
